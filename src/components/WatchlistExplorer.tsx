...
export default function WatchlistExplorer({ initialMovies }: { initialMovies: WatchlistMovie[] }) {
  ...
  async function remove(movie: WatchlistMovie) {
    ...
    try {
      ...
      notify(payload.message ?? "Removido da lista de espera.");
