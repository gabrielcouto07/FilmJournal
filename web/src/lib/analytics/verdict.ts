...
/** Dentro desta faixa a leitura vira "consenso" em vez de exigente/generoso. */
export const LEAN_NEUTRAL_BAND = 0.1;
export const MIN_TRAIT_COUNT = 3;

export type VerdictInput = {
  /** Só filmes avaliados entram na conta. */
  totalFilms: number;
...
export type Verdict = {
  ...
  /** Poucos dados: não deu para formar um perfil. */
  thin: boolean;
};
...
type Traits = {
  lean: Lean | null;
  /** Diferença com sinal: positivo é mais generoso que o público. */
